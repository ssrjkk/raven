# Raven — Fixes History (archive)

Verbatim archive of the "Fixes applied" log previously kept in AGENTS.md. Frozen record; superseded by CHANGELOG.md going forward.
