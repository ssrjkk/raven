...
def register_browser_tools(registry: ToolRegistry) -> None:
    ...
    registry.register(
        ToolSpec(
            ...
            parameters={
                ...
                "url": {"type": "string", "description": "Optional URL to navigate to first", "required": False},
                "timeout": {"type": "integer", "description": "Timeout in seconds", "required": False},
            },
    ...
    registry.register(
        ToolSpec(
            name="browser_type",
            description="Type text into an element with simulated keystrokes",
            parameters={
                "selector": {"type": "string", "description": "CSS selector", "required": True},
                "text": {"type": "string", "description": "Text to type", "required": True},
                "delay_ms": {"type": "integer", "description": "Delay between keystrokes in ms", "required": False},
                "url": {"type": "string", "description": "Optional URL first", "required": False},
                "timeout": {"type": "integer", "description": "Timeout in seconds", "required": False},
            },
    ...
    registry.register(
        ToolSpec(
            ...
            parameters={
                "selector": {"type": "string", "description": "CSS selector of select element", "required": True},
    ...
    registry.register(
        ToolSpec(
            ...
            description="Take a screenshot of a page or element as base64 image",
            parameters={
    ...
    registry.register(
        ToolSpec(
            ...
            description="Execute JavaScript in the browser page and return result",
            parameters={
    ...
    registry.register(
        ToolSpec(
            ...
            description="Get inner text of an element (default: entire page)",
            parameters={
                "selector": {"type": "string", "description": "CSS selector (default: body)", "required": False},
                "url": {"type": "string", "description": "Optional URL first", "required": False},
                "timeout": {"type": "integer", "description": "Timeout in seconds", "required": False},
            },
    ...
    registry.register(
        ToolSpec(
            ...
            description="Get inner HTML of an element (default: entire page)",
            parameters={
                "selector": {"type": "string", "description": "CSS selector (default: body)", "required": False},
                "url": {"type": "string", "description": "Optional URL first", "required": False},
                "timeout": {"type": "integer", "description": "Timeout in seconds", "required": False},
    ...
    registry.register(
        ToolSpec(
            ...
            handler=browser_get_attributes,
            category="web",
            timeout=30,
        )
    )
    registry.register(
        ToolSpec(
            ...
            parameters={
                ...
                "state": {
                    "type": "string",
                    "description": "Expected state: visible, hidden, attached",
                    "required": False,
                },
                "url": {"type": "string", "description": "Optional URL first", "required": False},
            },
    ...
    registry.register(
        ToolSpec(
            ...
            parameters={
                "direction": {"type": "string", "description": "Direction: down or up", "required": False},
                "amount": {"type": "integer", "description": "Pixels to scroll", "required": False},
                "url": {"type": "string", "description": "Optional URL first", "required": False},
                "timeout": {"type": "integer", "description": "Timeout in seconds", "required": False},
            },
    ...
    registry.register(
        ToolSpec(
            ...
            description="Fill multiple form fields at once using a JSON dict of {selector: value}",
            parameters={
                "fields": {
                    "type": "string",
                    "description": (
                        'JSON object mapping CSS selectors to values, e.g. {"#name": "John", "#email": "john@test.com"}'
                    ),
                    "required": True,
                },
                "timeout": {"type": "integer", "description": "Timeout in seconds", "required": False},
    ...
    registry.register(
        ToolSpec(
            ...
            description="Extract an HTML table as structured JSON (headers + row data)",
            parameters={
                "selector": {"type": "string", "description": "CSS selector of the table element", "required": True}
            },
            handler=browser_extract_table,
            category="web",
            timeout=30,
        )
    )
    registry.register(
        ToolSpec(
            ...
            description="Start or stop network request/response interception",
            parameters={
                "action": {
                    "type": "string",
                    "description": "'start' to begin capturing, 'stop' to end and report",
                    "required": False,
                }
            },
            handler=browser_intercept_network,
            category="web",
            timeout=10,
        )
    )
    registry.register(
        ToolSpec(
            ...
            description="Get captured network requests from active intercept session",
            parameters={},
            handler=browser_get_requests,
            category="web",
            timeout=10,
        )
    )
    registry.register(
        ToolSpec(
            name="browser_get_responses",
            description="Get captured network responses from active intercept session",
            parameters={},
            handler=browser_get_responses,
            category="web",
            timeout=10,
        )
    )
    registry.register(
        ToolSpec(
            ...
            description="Open a new browser tab (optionally navigate to URL)",
            parameters={
                "url": {
                    "type": "string",
    ...
    registry.register(
        ToolSpec(
            ...
            parameters={
                "index": {"type": "integer", "description": "Tab index to close (-1 for current)", "required": False}
            },
    ...
    registry.register(
        ToolSpec(
            ...
            parameters={"index": {"type": "integer", "description": "Tab index to switch to", "required": True}},
    ...
    registry.register(
        ToolSpec(
            ...
            description="Wait for and capture a downloaded file as base64",
            parameters={"timeout": {"type": "integer", "description": "Max wait time in seconds", "required": False}},
    ...
    registry.register(
        ToolSpec(
            ...
            description="Set extra HTTP headers for all requests from this page",
            parameters={
                "headers": {"type": "string", "description": "JSON object of header key-value pairs", "required": True}
            },
            handler=browser_set_headers,
            category="web",
            timeout=10,
        )
    )
    registry.register(
        ToolSpec(
            name="browser_wait_function",
            description="Wait until a JavaScript function returns a truthy value",
            parameters={
                "fn": {
                    "type": "string",
                    "description": (
                        "JavaScript function body to evaluate "
                        "(e.g. '() => document.querySelectorAll(\".item\").length > 5')"
                    ),
                    "required": True,
                },
                "timeout": {"type": "integer", "description": "Timeout in seconds", "required": False},
            },
            handler=browser_wait_function,
            category="web",
            timeout=60,
        )
    )
    registry.register(
        ToolSpec(
            ...
            parameters={"timeout": {"type": "integer", "description": "Timeout in seconds", "required": False}},
            handler=browser_wait_navigation,
            category="web",
            timeout=60,
        )
    )
    ...
    registry.register(
        ToolSpec(
            ...
            description="Set cookies for the current browser context from JSON array",
            parameters={
                "cookies": {
                    "type": "string",
                    "description": 'JSON array of cookie objects: [{"name":"x","value":"y","url":"..."}]',
                    "required": True,
                }
            },
