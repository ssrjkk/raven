...
async def github_create_pr(
    owner: str, repo: str, title: str, body: str = "", head: str = "main", base: str = "main"
...
async def github_trigger_workflow(
    owner: str, repo: str, workflow_id: str, ref: str = "main", inputs: dict[str, str] | None = None
) -> dict[str, Any] | list[Any]:
...
async def github_merge_pr(
    owner: str, repo: str, number: int, merge_method: str = "merge"
) -> dict[str, Any] | list[Any]:
...
async def github_search_code(
    owner: str, repo: str, query: str, page: int = 1, per_page: int = 10
) -> dict[str, Any] | list[Any]:
...
def register_github_tools(registry: ToolRegistry) -> None:
    registry.register(
        ToolSpec(
            ...
            parameters={
                ...
                "sort": {
                    "type": "string",
                    "description": "Sort: updated, created, pushed, full_name",
                    "default": "updated",
                },
            },
    ...
    registry.register(
        ToolSpec(
            ...
            handler=github_trigger_workflow,
            category="github",
        )
    )
    registry.register(
